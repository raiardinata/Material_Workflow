<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="extendPlantPageDisplay.aspx.cs" Inherits="testForm.Pages.extendPlantPageDisplay" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div runat="server" id="listViewExtend" style="padding: 0px 5px">
                <h1>R&D Extend Plant - Display Data</h1>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <asp:GridView ID="GridViewListView" runat="server"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="150px" HeaderText="Transaction ID">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="slcExtendMaterial" Text='<%#Eval("TransID")%>' OnClick="slcExtendMaterial_Click" />
                                        ...
                                        <asp:BoundField DataField="Notes" HeaderText="Notes" ItemStyle-Width="500" />
                        ...
                        <table style="border-collapse: separate; width: initial; height: initial; margin: 0px auto 5px auto">
                            <tr style="height: initial;">
                                <td style="width: auto; height: auto; vertical-align: top; top: auto; right: auto; bottom: auto; left: auto; padding: 5px 7px 5px 0px">
                                    ...
                                    <fieldset class="group-border" runat="server" id="foreignTradeDt" style="width: 100%" visible="false">
                                    ...
                                    <fieldset class="group-border" runat="server" id="plantShelfLifeDt" style="width: 100%">
                                        ...
                                        <table style="margin: auto auto 5px 5px; width: initial">
                                            <tr>
                                                ...
                                                <td style="width: 150px;">
                                                    <asp:Label runat="server" ID="lblMinRemShelf" Text="DAY" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="lblTd">
                                                    <asp:Label runat="server" ID="Label41" Text="Period Ind. for SLED " />
                                                </td>
                                                <td style="width: 105px">
                                                    <asp:DropDownList runat="server" ID="ddListSLED" type="text" placeholder="Period Ind. for SLED" autocomplete="off" onkeypress="return this.value.length<=1" CssClass="txtBoxRO">
                                        ...
                                        <table style="margin: auto auto 5px 7px; width: initial">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px" class="txtBox">
                                                    ...
                                                    <%--AutoPostBack="true" --%>
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" runat="server" ID="inputSpcProcRnd" type="text" />
                        ...
                        <table style="border-collapse: separate; width: initial; height: initial; margin: 0px auto 5px auto">
                                    ...
                                    <fieldset class="group-border" runat="server" visible="false" id="purchValNOrder" style="width: 100%; height: auto; top: auto; right: auto; bottom: auto; left: auto;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" runat="server" ID="inputGRProcTimeMRP1" type="text" ReadOnly="true" CssClass="txtBox" />
                            ...
                            <tr style="height: initial;">
                                ...
                                <td colspan="2">
                                                ...
                                                <td style="width: 100%">
                                                    <asp:Repeater ID="reptUntMeasProc" runat="server" Visible="true">
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="text-align: center; width: 100%; margin: auto auto auto auto" cellpadding="0">
                                                                <tr style="background-color: #EBEFF0">
                                                                    <asp:Label CssClass="hiddenLabel" ID="Label1" runat="server" Text='<%#Eval("DetailID") %>' />
                                                                    <asp:Label CssClass="hiddenLabel" ID="Label2" runat="server" Text='<%#Eval("TransID") %>' />
                                                                    <asp:Label CssClass="hiddenLabel" ID="Label5" runat="server" Text='<%#Eval("MaterialID") %>' />
                                                                    <!--X-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label6" runat="server" Text='<%#Eval("X") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox1" runat="server" Text='<%#Eval("X") %>' Visible="false" Width="100px" autocomplete="off" />
                                                                    </td>
                                                                    <!--Aun-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label7" runat="server" Text='<%#Eval("Aun") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox2" runat="server" Text='<%#Eval("Aun") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--AunMeas-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px; display: none;">
                                                                    ...
                                                                    <!--Y-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label10" runat="server" Text='<%#Eval("Y") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox3" runat="server" Text='<%#Eval("Y") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--Bun-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label14" runat="server" Text='<%#Eval("Bun") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox4" runat="server" Text='<%#Eval("Bun") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--BunMeas-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px; display: none">
                                                                    ...
                                                                    <!--Gross Weight-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label21" runat="server" Text='<%#Eval("GrossWeight") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox5" runat="server" Text='<%#Eval("GrossWeight") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--Weight Unit-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label25" runat="server" Text='<%#Eval("WeightUnit") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox6" runat="server" Text='<%#Eval("WeightUnit") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--Volume-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label27" runat="server" Text='<%#Eval("Volume") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox7" runat="server" Text='<%#Eval("Volume") %>' Visible="false" Width="100px" />
                                                                    </td>
                                                                    <!--Vol Unit-->
                                                                    <td style="background-color: #EBEFF0; border-top: 1px dotted #8AE0F2; width: 100px">
                                                                        <asp:Label ID="Label29" runat="server" Text='<%#Eval("VolUnit") %>' />
                                                                        <asp:TextBox onkeydown="return(event.keyCode!=13);" ID="TextBox8" runat="server" Text='<%#Eval("VolUnit") %>' Visible="false" Width="100px" autocomplete="off" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                    ...
                                    <asp:Label runat="server" ID="Label31" Text="" ForeColor="Red" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                                    ...
                                    <fieldset class="group-border" runat="server" visible="false" id="bscDt1GnrlDtPlanner" style="width: 100%;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 178px; height: 30px;">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" runat="server" ID="inputLabOffice" type="text" />
                                                </td>
                                                <td>
                                    ...
                                    <fieldset class="group-border" runat="server" id="MRP1" visible="false" style="width: 100%; height: auto; top: auto; right: auto; bottom: auto; left: auto;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" ReadOnly="true" CssClass="txtBox" runat="server" ID="inputMRPGr" type="text" />
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" ReadOnly="true" CssClass="txtBox" runat="server" ID="inputMRPTyp" type="text" OnTextChanged="inputMRPTyp_TextChanged" AutoPostBack="true" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" ReadOnly="true" CssClass="txtBox" runat="server" ID="inputMRPCtrl" type="text" OnTextChanged="inputMRPCtrl_TextChanged" AutoPostBack="true" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" ReadOnly="true" CssClass="txtBox" runat="server" ID="inputLOTSize" type="text" OnTextChanged="inputLOTSize_TextChanged" AutoPostBack="true" required="true" />
                                                </td>
                                                <td>
                                ...
                                <td style="width: auto; height: auto; vertical-align: top; top: auto; right: auto; bottom: auto; left: auto; padding: 5px 0px 5px 7px">
                                    ...
                                    <fieldset class="group-border" runat="server" id="MRP3" visible="false" style="width: 100%; height: auto; top: auto; right: auto; bottom: auto; left: auto;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            <tr>
                                                ...
                                                <td style="width: 150px">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" ReadOnly="true" CssClass="txtBox" runat="server" ID="inputStrtgyGr" type="text" AutoPostBack="true" OnTextChanged="inputStrtgyGr_TextChanged" />
                                                </td>
                                                <td>
                                    ...
                                    <fieldset class="group-border" runat="server" id="WorkingSchedule" visible="true" style="width: 100%; height: auto; top: auto; right: auto; bottom: auto; left: auto;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            <tr>
                                                <td style="width: 150px; text-align: right">
                                                    <asp:Label runat="server" ID="Label33" Text="Production Scheduler " />
                                                </td>
                                                <td style="width: 150px">
                                            ...
                                            <tr>
                                                <td style="width: 150px; text-align: right">
                                                    <asp:Label runat="server" ID="Label34" Text="Production Scheduler Profile " />
                                                </td>
                                                <td style="width: 150px">
                                    ...
                                    <fieldset class="group-border" runat="server" visible="true" id="Fieldset2" style="width: 100%;">
                                        ...
                                        <table style="margin: 0px auto 5px 5px; width: initial">
                                            <tr>
                                                ...
                                                <td class="txtBox" style="text-align: left;">
                                                    <asp:TextBox onkeydown="return(event.keyCode!=13);" CssClass="txtBoxRO" runat="server" ID="inputTypeQA" type="text" ReadOnly="true" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="lblBsDt">
                ...
                <table style="border-collapse: separate; width: initial; height: initial; margin: 0px 12px 5px auto">
                    <tr>
                        <td>
                            ...
                            <asp:Button CssClass="btn btn-info btn-danger" runat="server" ID="btnCancelApprove" Text="Reject" Visible="false" CausesValidation="False" UseSubmitBehavior="false" OnClick="btnCancelApprove_Click" />
                                ...
                                <asp:GridView ID="GridViewLabOffice" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <%-- <asp:LinkButton runat="server" ID="LinkButton1" OnClick="selectIndStdDesc_Click">Select Ind. Std.</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton1" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("LabOffice") + "," + Eval("Lab_Desc") %>' OnClick="selectLabOffice_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewStoreCond" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <%-- <asp:LinkButton runat="server" ID="LinkButton1" OnClick="selectIndStdDesc_Click">Select Ind. Std.</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton2" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("StorConditions") + "," + Eval("StorConditionsDesc") %>' OnClick="selectStorCond_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton3" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("MaterialID") %>'>
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton4" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("Plant") + "," + Eval("Plant_Desc")  %>' OnClick="selectPlant_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton5" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SLoc") + "," + Eval("SLoc_Desc")%>' OnClick="selectStorLoc_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton6" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SOrg") + "," + Eval("SOrg_Desc") %>' OnClick="selectSalesOrg_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton7" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SpclProcurement") + "," + Eval("SpclProcDesc") %>' OnClick="selectSpcProc_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton8" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ForeignTrade") + "," + Eval("ForeignDesc") %>' OnClick="selectCommImp_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewCommImp2" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                <%--  <asp:LinkButton runat="server" ID="lnkView" OnClick="selectCommImp_Click">Select This Plant</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton9" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ForeignTrade") + "," + Eval("ForeignDesc") %>'>
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewLoadingGroup" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                <%--  <asp:LinkButton runat="server" ID="lnkView" OnClick="selectCommImp_Click">Select This Plant</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton10" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("LoadGrp") + "," + Eval("LoadGrpDesc") %>' OnClick="selectLoadingGrp_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewPurchasingGroup" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                <%--  <asp:LinkButton runat="server" ID="lnkView" OnClick="selectCommImp_Click">Select This Plant</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton11" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("PurchGrp") + "," + Eval("PurchGrpDesc") %>' OnClick="selectPurcGrp_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton12" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("MRPGroup") +"," + Eval("MRPGroupDesc") + "," + Eval("Plant")%>' OnClick="selectMRPGr_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton13" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("MRPType") + "," + Eval("MRPTypeDesc") %>' OnClick="selectMRPTyp_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton14" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("MRPController") + "," + Eval("MRPControllerDesc") %>' OnClick="selectMRPCtrl_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton15" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("LotSize") + "," + Eval("LotSizeDesc")%>' OnClick="selectLOTSize_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton16" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ProcType") %>' OnClick="selectProcType_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton17" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ProcType") + "," + Eval("ProcTypeDesc")%>' OnClick="selectProcType_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewSpcProcPlanner" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <%--<asp:LinkButton runat="server" ID="LinkButton1" OnClick="selectSpcProc_Click">Select This SpcProcurement</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton18" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SpclProcurement") + "," + Eval("SpclProcDesc") %>' OnClick="selectSpcProc_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <%--OnClick="selectStorLoc_Click"--%>
                                                <%--  <asp:LinkButton runat="server" ID="LinkButton2" >Select This Store Location</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton19" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SLoc") + ","+ Eval("SLoc_Desc") %>' OnClick="selectProdStorLoc_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <%--OnClick="selectStorLoc_Click"--%>
                                                <%--  <asp:LinkButton runat="server" ID="LinkButton2" >Select This Store Location</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton20" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("SchedType") + "," + Eval("SchedMarginType") %>' OnClick="selectSchedMargKey_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="50">
                                            <ItemTemplate>
                                                <%--OnClick="selectStorLoc_Click"--%>
                                                <%--  <asp:LinkButton runat="server" ID="LinkButton2" >Select This Store Location</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton21" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("PlanStrategyGroup") + "," + Eval("PlanStrategyGrpDesc") %>' OnClick="selectStrategyGroup_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="50">
                                            <ItemTemplate>
                                                <%--OnClick="selectStorLoc_Click"--%>
                                                <%--  <asp:LinkButton runat="server" ID="LinkButton2" >Select This Store Location</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton22" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ProdSched") + "," + Eval("ProdSchedDesc")  + "," + Eval("ProdSchedProfile")  %>' OnClick="selectProdSched_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="50">
                                            <ItemTemplate>
                                                <%--OnClick="selectStorLoc_Click"--%>
                                                <%--  <asp:LinkButton runat="server" ID="LinkButton2" >Select This Store Location</asp:LinkButton>--%>
                                                <asp:LinkButton ID="LinkButton23" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ProdSchedProfile") + "," + Eval("ProdSchedProfileDesc")%>' OnClick="selectProdSchedProfile_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridViewProfitCent" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LinkButton24" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ProfitCenter") %>'>
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridViewValClass" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LinkButton25" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("ValuationClass") %>'>
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="250">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LinkButton26" ClientIDMode="AutoID" runat="server" CommandName="Select" CommandArgument='<%#Eval("PurchValueKey") %>' OnClick="selectPurcValKey_Click">
                                                                 <span aria-hidden="true" class="glyphicon glyphicon-plus">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
