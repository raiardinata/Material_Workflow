...
{
    public partial class displayExtendMaterial : System.Web.UI.Page
    {
        string stringCoProd = "";
        ...
        private void gridSearch(string Filter)
        {
            if (Filter.Trim().ToUpper() == "ALL")
            {
                if (lsbxMatIDDESC.SelectedItem.Text == "Material ID")
                {
                    ...
                    var dt = GetData_srcListViewMatID("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "E");
                ...
                else
                {
                    ...
                    string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                    string Row = ddlPageSize.SelectedValue;
                    var dt = GetData_srcListViewMatDESC("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "E");
            ...
            else if (Filter.Trim().ToUpper() == "RM")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "E", lblPosition.Text.Trim(), "RM");
            ...
            else if (Filter.Trim().ToUpper() == "SF")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "E", lblPosition.Text.Trim(), "SF");
            ...
            else if (Filter.Trim().ToUpper() == "FG")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "E", lblPosition.Text.Trim(), "FG");
