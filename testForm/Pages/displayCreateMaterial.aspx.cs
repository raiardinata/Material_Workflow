...
{
    public partial class displayCreateMaterial : System.Web.UI.Page
    {
        string stringCoProd = "";
        ...
        private void gridSearch(string Filter)
        {
            if (Filter.Trim().ToUpper() == "ALL")
            {
                if (lsbxMatIDDESC.SelectedItem.Text == "Material ID")
                {
                    ...
                    var dt = GetData_srcListViewMatID("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "");
                ...
                else
                {
                    ...
                    string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                    string Row = ddlPageSize.SelectedValue;
                    var dt = GetData_srcListViewMatDESC("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "");
