...
{
    public partial class displaySampleMaterial : System.Web.UI.Page
    {
        string stringCoProd = "";
        ...
        protected void modifyThisFico_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("~/Pages/displaySampleMaterial");
            }
        }
        ...
        private void gridSearch(string Filter)
        {
            if (Filter.Trim().ToUpper() == "ALL")
            {
                if (lsbxMatIDDESC.SelectedItem.Text == "Material ID")
                {
                    ...
                    var dt = GetData_srcListViewMatID("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "X");
                ...
                else
                {
                    ...
                    string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                    string Row = ddlPageSize.SelectedValue;
                    var dt = GetData_srcListViewMatDESC("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim(), "X");
            ...
            else if (Filter.Trim().ToUpper() == "RM")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "X", lblPosition.Text.Trim(), "RM");
            ...
            else if (Filter.Trim().ToUpper() == "SF")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "X", lblPosition.Text.Trim(), "SF");
            ...
            else if (Filter.Trim().ToUpper() == "FG")
            {
                ...
                string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                string Row = ddlPageSize.SelectedValue;
                var dt = GetData_srcListViewRMSFFG("R&D", "X", lblPosition.Text.Trim(), "FG");
