<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="displaySampleMaterial.aspx.cs" Inherits="testForm.Pages.displaySampleMaterial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="listViewFico" style="padding: 0px 5px">
        <h1>Sample Material Master Data</h1>
    ...
    <fieldset runat="server" id="rmContent" visible="false" style="width: auto">
        <legend style="padding: 0px 2px 0px 2px">Request New Material - Sample Material Master Display</legend>
