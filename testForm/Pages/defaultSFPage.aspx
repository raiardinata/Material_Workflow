<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="defaultSFPage.aspx.cs" Inherits="testForm.Pages.defaultSFPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-size: 2rem; display: none; position: absolute">
        ...
        <asp:Label runat="server" ID="lblType" Text="SF" />
    </span>
    <fieldset style="width: initial; padding: 5px 5px">
        <legend style="padding: 0px 2px 0px 2px">Material Default Value - Semi Finished</legend>
