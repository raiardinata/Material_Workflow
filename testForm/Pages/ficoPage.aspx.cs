...
{
    public partial class ficoPage : System.Web.UI.Page
    {
        string stringCoProd = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (lblPosition.Text != "FICO" && lblPosition.Text != "FICO MGR")
                {
        ...
        protected DataTable GetData_srcListViewRMSFFG(string Module_User, string Division, string Type)
        {
            DataTable dt;
            ...
            dt = sqlC.ExecuteDataTable("srcListViewRMSFFGFICO", param);
        ...
        protected DataTable GetData_srcListViewMatID(string inputMatIDDESC, string Module_User, string Division)
        {
            DataTable dt;
            SqlParameter[] param = new SqlParameter[3];
            ...
            //send param to SP sql
            dt = sqlC.ExecuteDataTable("srcListViewMatIDFICO", param);

            return dt;
        }
        protected DataTable GetData_srcListViewMatDESC(string inputMatIDDESC, string Module_User, string Division)
        {
            DataTable dt;
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@inputMatIDDESC", inputMatIDDESC);
            ...
            //send param to SP sql
            dt = sqlC.ExecuteDataTable("srcListViewMatDESCFICO", param);
        ...
        protected void modifyThisFico_Click(object sender, EventArgs e)
        {
            ...
            else if (lblPosition.Text == "FICO MGR")
            {
                ...
                if (inputFicoPlant.Text == "5200" && inputMatTyp.Text.ToUpper() == "RMSV")
                {
            ...
            else
            {
                ...
                Response.Redirect("~/Pages/ficoPage");
            }
        }
        ...
        private void gridSearch(string Filter)
        {
            if (Filter.Trim().ToUpper() == "ALL")
            {
                if (lsbxMatIDDESC.SelectedItem.Text == "Material ID")
                {
                    ...
                    var dt = GetData_srcListViewMatID("%" + inputMatIDDESC.Text.Trim() + "%", "R&D", lblPosition.Text.Trim());
                ...
                else
                {
                    ...
                    string StartRow = (GridViewListView.PageIndex * GridViewListView.PageSize).ToString();
                    string Row = ddlPageSize.SelectedValue;
                    var dt = GetData_srcListViewMatDESC("%" + inputMatIDDESC.Text.Trim() + "%", "R&D", lblPosition.Text.Trim());
        ...
        private void SortGridView(string sortExpression, string direction)
        {
            ...
            DataTable dt = GetData_srcListViewMatID("%" + inputMatIDDESC.Text.ToUpper().Trim() + "%", "R&D", lblPosition.Text.Trim());
