<%@ Page Title="Financial and Controlling Site" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="ficoPage.aspx.cs" Inherits="testForm.Pages.ficoPage" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="modal-body">
                        <asp:GridView ID="GridViewListView" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Plant" HeaderText="Plant" ItemStyle-Width="50" SortExpression="Plant" />
    ...
    <fieldset runat="server" id="rmContent" visible="false" style="width: auto">
        <legend style="padding: 0px 2px 0px 2px">Request New Material - Finance Controlling</legend>
                            ...
                            <fieldset runat="server" visible="false" id="purchValNOrder" style="width: 100%; height: auto; top: auto; right: auto; bottom: auto; left: auto;">
                                ...
                                <table style="margin: 0px auto 5px 5px; width: initial">
                                    ...
                                    <tr runat="server" id="trPlantDeliveryTime" visible="true">
                                        ...
                                        <td style="width: 105px">
                                             <asp:TextBox onkeydown="return(event.keyCode!=13);" runat="server" ID="inputPlantDeliveryTime" type="text" autocomplete="off" onkeypress="return this.value.length<=9" ReadOnly="true" CssClass="txtBoxRO" />
                                        </td>
                                        <td style="width: 150px;">
        ...
        <div class="modal fade" id="modalRejectFICO" role="dialog">
            <div class="modal-dialog" style="max-width: 590px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button CssClass="btn btn-info btn-danger" runat="server" ID="btnFICO" Text="Revision" OnClick="RevisionFico_Click" Visible="true" />
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
